...
class Code_table_reading:
    ...
    def f_decode_codewords(self,seat,symbol_composition):
        codewords=[]
        codewords.append('1');codewords.append('2');codewords.append('3');codewords.append('4');
        codewords_temp=codewords
        
        for i in range(1,len(seat)+1):
            seat_c=seat[-i]
            codewords=[]
            codewords.append(codewords_temp[seat_c]+'1');codewords.append(codewords_temp[seat_c]+'2');codewords.append(codewords_temp[seat_c]+'3');codewords.append(codewords_temp[seat_c]+'4');
            codewords_temp.pop(seat_c)
            codewords=codewords+codewords_temp
            codewords_temp=codewords
    ...
    def f_decode_infomation_table(self,string):
        ...
        symbol_composition=[];[symbol_composition.append(chr(value)) for value in string_decimal]
...
def decode_txt_pic(sequences,codewords,symbol_composition):
    flag_error=0  
    result='';
    i=0;
    while(i<=len(sequences)-1):
        ...
        result +=symbol_composition[index]
        i +=gap
